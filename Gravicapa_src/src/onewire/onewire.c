...
uint8_t ds_init(){
    ...
    GPIOB->CRH   &= ~GPIO_CRH_MODE10;      //Очистить биты MODE
    GPIOB->CRH   &= ~GPIO_CRH_CNF10;       //Очистить биты CNF
    GPIOB->CRH   |=  GPIO_CRH_MODE10_1 ;   //Выход,частота 2MHz
    GPIOB->CRH   |=  GPIO_CRH_CNF10_0;     //Открытый сток общего назначения
    GPIOB->ODR   |=  1<<PIN ;               //отпустить шину
